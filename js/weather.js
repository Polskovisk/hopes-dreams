...
function getweather(callback) {
    var location = localStorage.location || 'são paulo'
    var request = new XMLHttpRequest(),
        url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&units=metric&appid=c4504024dcb408763057f53ae754b1a0`;
